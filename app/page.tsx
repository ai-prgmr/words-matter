...
export default function Home() {
  ...
  const publications = [
    { name: "The Times of India", node: <div className="font-league text-2xl md:text-3xl font-bold uppercase tracking-widest text-charcoal/40 dark:text-white/40 hover:text-charcoal dark:hover:text-white transition-all duration-300 whitespace-nowrap cursor-default">THE TIMES OF INDIA</div> },
    { name: "News 18", node: <div className="font-league text-3xl md:text-4xl font-black uppercase tracking-tighter text-charcoal/40 dark:text-white/40 hover:text-charcoal dark:hover:text-white transition-all duration-300 whitespace-nowrap cursor-default">NEWS <span className="text-red-600/40 hover:text-red-600 transition-colors">18</span></div> },
    { name: "NDTV", node: <div className="font-league text-3xl md:text-4xl font-black tracking-tighter text-charcoal/40 dark:text-white/40 hover:text-charcoal dark:hover:text-white transition-all duration-300 whitespace-nowrap cursor-default">NDTV</div> },
    { name: "Zee News", node: <div className="font-league text-2xl md:text-3xl font-extrabold uppercase tracking-tight text-charcoal/40 dark:text-white/40 hover:text-charcoal dark:hover:text-white transition-all duration-300 whitespace-nowrap flex items-center gap-1.5 cursor-default"><div className="w-6 h-6 bg-red-600/40 group-hover:bg-red-600 transition-colors"></div>ZEENEWS</div> },
    { name: "Hindustan Times", node: <div className="font-league text-2xl md:text-3xl font-bold tracking-tighter text-charcoal/40 dark:text-white/40 hover:text-blue-500 dark:hover:text-cyan-400 transition-all duration-300 whitespace-nowrap cursor-default">hindustan<span className="font-black text-cyan-600/40 hover:text-cyan-500 transition-colors">times</span></div> },
    { name: "Business Standard", node: <div className="font-league text-2xl md:text-3xl font-medium tracking-tight text-charcoal/40 dark:text-white/40 hover:text-red-700 dark:hover:text-red-400 transition-all duration-300 whitespace-nowrap cursor-default">Business Standard</div> },
    { name: "ET Economic Times", node: <div className="font-league text-2xl md:text-3xl font-bold tracking-tight text-charcoal/40 dark:text-white/40 hover:text-red-600 dark:hover:text-red-500 transition-all duration-300 whitespace-nowrap flex items-center gap-2 cursor-default"><span className="px-2 py-1 bg-transparent border border-gray-200 dark:border-gray-800">ET</span> <span className="font-normal text-xl md:text-2xl">ECONOMIC TIMES</span></div> },
    { name: "Livemint", node: <div className="font-league text-3xl md:text-4xl font-bold tracking-tight text-charcoal/40 dark:text-white/40 hover:text-orange-500 dark:hover:text-orange-400 transition-all duration-300 whitespace-nowrap cursor-default">live<span className="font-black">mint</span></div> },
    { name: "Mid-Day", node: <div className="font-league text-3xl md:text-4xl font-black tracking-tighter text-charcoal/40 dark:text-white/40 hover:text-blue-700 dark:hover:text-blue-500 transition-all duration-300 whitespace-nowrap flex items-baseline">mid-day<span className="text-sm font-bold text-red-500/40 ml-1 rounded">.com</span></div> },
    { name: "Deccan Chronicle", node: <div className="font-league text-2xl md:text-3xl font-bold text-charcoal/40 dark:text-white/40 hover:text-charcoal dark:hover:text-white transition-all duration-300 whitespace-nowrap leading-none flex flex-col items-center cursor-default"><span className="text-sm tracking-widest uppercase">Deccan</span><span className="text-3xl md:text-4xl tracking-tighter mt-1">Chronicle</span></div> },
    { name: "Deccan Herald", node: <div className="font-league text-2xl md:text-3xl font-bold tracking-tight text-charcoal/40 dark:text-white/40 hover:text-cyan-700 dark:hover:text-cyan-400 transition-all duration-300 whitespace-nowrap flex items-center gap-2 cursor-default"><span className="text-4xl md:text-5xl text-cyan-700/40">DH</span><span className="text-[10px] uppercase tracking-widest flex-col leading-tight hidden md:flex text-charcoal/40 dark:text-white/40"><span>Deccan</span><span>Herald</span></span></div> },
    { name: "ANI", node: <div className="font-league text-4xl md:text-5xl font-black tracking-tighter text-charcoal/40 dark:text-white/40 hover:text-charcoal dark:hover:text-white transition-all duration-300 whitespace-nowrap flex items-center gap-3 cursor-default">ANI<span className="text-[9px] uppercase font-bold tracking-widest text-gray-400/60 w-32 leading-tight hidden md:block whitespace-normal text-left border-l border-gray-300/30 pl-3">South Asia's Leading News Agency</span></div> }
  ];
      ...
      <div className="min-h-screen relative overflow-hidden bg-gray-100/20">
          ...
          <div className="max-w-7xl mx-auto w-full relative flex items-center justify-center z-10">
            ...
            <div className="relative z-20 flex flex-col items-center justify-center text-center w-full pointer-events-none">
              <div className="relative group cursor-default pointer-events-auto">
                <h1 className="text-[2rem] md:text-[4rem] font-bold tracking-tighter text-primary dark:text-white transition-transform duration-700 ease-out hover:scale-105">
                  Powerful Words,
              ...
              <div className="flex flex-col items-center relative bg-transparent backdrop-blur-sm w-full max-w-xl mx-auto pointer-events-auto text-center gap-y-8">
                ...
                <h2 className="text-2xl md:text-4xl leading-tight font-bold max-w-xl px-4 text-slate-900 dark:text-white">
                  ...
                  <span className="inline-flex flex-col h-[1.2em] overflow-hidden align-bottom text-left min-w-[150px] md:min-w-[200px]">
                    ...
                    <span className="animate-slide-up flex flex-col">
                      <span className="h-[1.2em] flex items-center font-league italic text-[#B9915D] dark:text-blue-400">Influence.</span>
                      <span className="h-[1.2em] flex items-center font-league italic text-[#B9915D] dark:text-blue-400">Authority.</span>
                      <span className="h-[1.2em] flex items-center font-league italic text-[#B9915D] dark:text-blue-400">Resonance.</span>
                      <span className="h-[1.2em] flex items-center font-league italic text-[#B9915D] dark:text-blue-400">Impact.</span>
                      {/* Duplicate for seamless loop */}
                      <span className="h-[1.2em] flex items-center font-league italic text-[#B9915D] dark:text-blue-400" aria-hidden="true">Influence.</span>
                    </span>

                  </span>
                </h2>

                <p className="mt-4 text-sm md:text-base text-slate-600 dark:text-slate-400 max-w-md mx-auto">
        ...
        <AnimatedSection className="py-24 px-8 md:px-12 dark:border-gray-800" >
          <div className="max-w-3xl mx-auto">
            <blockquote className="relative">
              ...
              <p className="relative z-10 font-league text-4xl md:text-6xl italic leading-tight text-center text-charcoal dark:text-gray-100">
              ...
              {servicesData.slice(0, 3).map((service) => (
                <Link key={service.id} href={`/services/${service.slug}`} className="block group cursor-pointer">
                  <div className="flex flex-col gap-6">
                    ...
                    <div>
                      <h3 className="text-3xl font-bold mb-4 group-hover:text-primary transition-colors leading-tight text-charcoal dark:text-white">{service.title}</h3>
                      <p className="text-lg text-gray-900 dark:text-gray-300 leading-relaxed pr-6">
                        {service.shortDesc}
                      </p>
                    </div>
                  </div>
        ...
        <AnimatedSection className="py-24 md:py-32 overflow-hidden relative border-b border-gray-200 dark:border-gray-800 dark:bg-background-dark" >
          <div className="max-w-7xl mx-auto px-6 md:px-12 mb-16 md:mb-24 text-center relative z-10">
            ...
            <p className="text-gray-900 dark:text-gray-300 max-w-2xl mx-auto text-lg md:text-xl font-medium leading-relaxed">
