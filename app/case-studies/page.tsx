...
export const metadata = {
    ...
    description: 'Explore case studies from Words Matter. Detailed examples of our strategic PR, reputation management, and perception architecture in action for our clients.',
    openGraph: {
        title: 'Case Studies | Words Matter',
        description: 'Explore case studies from Words Matter. Detailed examples of our strategic PR, reputation management, and perception architecture in action for our clients.',
