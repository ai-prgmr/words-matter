...
const ContactForm = () => {
    ...
    const GOOGLE_SCRIPT_URL = "https://script.google.com/macros/s/AKfycbwanDPudfVQgb9AfYg0KcpAg5uiebd2LtAtlFa1b5Kl42J3zQ2MMezMV8rWV_Zs2XJ3/exec";
    ...
    return (
        <div className="max-w-lg mx-auto p-8 bg-white border border-slate-100 shadow-xl rounded-2xl font-sans text-slate-900">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                ...
                <button
                    ...
                    className="w-full bg-slate-900 text-white font-medium py-3 rounded-lg hover:bg-slate-800 transition-all active:scale-[0.98] disabled:bg-slate-300"
                >
                ...
                {status === "SUCCESS" && (
                    <div className="animate-fade-in-up flex flex-col items-center justify-center p-6 bg-slate-50 border border-slate-200 rounded-xl space-y-3">
                        ...
                        <button
                            ...
                            className="text-xs font-semibold text-indigo-600 hover:text-indigo-500 uppercase tracking-widest"
                        >
                            Send another?
                        </button>
                    </div>
