            ...
            <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                    ...
                    <div className="md:text-right">
                        ...
                        <a className="block text-sm text-gray-600 hover:text-primary transition-colors" href={`mailto:${email_address}`}>{email_address}</a>
                        <a className="block text-sm text-gray-600 hover:text-primary transition-colors mt-1" href={`tel:${phone_number.replace(/\s+/g, '')}`}>{phone_number}</a>
                    </div>
                </div>
